    ...
    >
      <div className="container-custom relative z-10">
        ...
        <div className="text-center mb-16 max-w-4xl mx-auto">
          <Title title="Sustentabilidad" type="secondary" />
          <p className="
            text-sm md:text-base lg:text-lg
            text-white/70 font-light leading-relaxed max-w-full mx-auto
          ">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 mb-16">
          <div className="lg:w-1/3">
            <div className="relative">
              <img 
                ...
                className="rounded-xl shadow-lg w-full object-cover h-[300px] sm:h-[350px] md:h-[400px] relative z-10"
              />
            </div>
            {/* Call to Action */}
          ...
          <div className="lg:w-2/3 p-4 sm:p-6 bg-primary-dark rounded-2xl overflow-hidden">
            <h3 className="
            ...
            <p className="
              text-sm md:text-base lg:text-lg
              text-white text-opacity-80 mb-6 sm:mb-8
            ">
